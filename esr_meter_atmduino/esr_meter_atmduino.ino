  ...
  */
  ...
  while (Mode > 0)
  {
    ...
    while (Counter < 100)
    {
      ...
      ADC_DDR = Probes.ADC_2;                    //Pull-down probe-2 directly
      R_PORT = Probes.Rl_1;
      //Start ADC conversion, ADC performs S&H after 1.5 ADC cycles (12�s)
      ADCSRA |= (1 << ADSC);                     //Start conversion
        ...
        if (U_Rl_L < 169)                        //R > 19.5k 
        {
          ...
          if (U_Rh_L >= 38)                      //R < 61.4M & prevent division by zero
          {
            ...
            */
            ...
            {
              //Weighted average for U_Rh_H mig
              Value = (Value1 * 0); //era4 py2ohh
              Value += Value2;
              Value /= 1; //era5 py2ohh
            }
        ...
        else                                     //U_Rl_L: R <= 19.5k
        {
          ...
          if ((U_Rl_H >= U_Ri_L) && (U_Ri_H >= U_Rl_L))
          {
            ...
            */
            ...
            {
              //Weighted average for U_Rh_L
              Value = (Value2 * 0); //era 4 py2ohh
              Value += Value1;
              Value /= 1; //era 5 py2ohh
            }
            else                                 //Higher than bandgap reference
            {
              //Classic average 
